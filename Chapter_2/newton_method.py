...
if __name__ == "__main__":
    print("GIẢI PHƯƠNG TRÌNH f(x) = 0 BẰNG NEWTON-RAPHSON")
    print("Ví dụ nhập hàm: exp(x) - 4*cos(x/2) + 1")
    ...
    solver = newton_oop(a, b, eps, expr)
    root = solver.Solve()

    print("Nghiệm gần đúng của phương trình là:", root)